  ...
  providers: [
    GitHubProvider({
      ...
      async profile(profile) {
        const { id, name, login, email } = profile;
        const getUser = await getUserAuthOptions({ id, name: name ?? login, email })
    ...
    GoogleProvider({
      ...
      async profile(profile) {
        console.log("GoogleProvider GoogleProvider GoogleProvider", profile)
