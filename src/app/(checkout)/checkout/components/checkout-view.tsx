...
import { CheckoutFormType, CheckoutSchema } from "@/components/shared/checkout/schemas/chekout-schema";
    ...
    >
      ...
      <FormProvider {...methods}>
        <form onSubmit={methods.handleSubmit(onSubmit)}>
          <div
            className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-6 lg:gap-10"
          >
            <div
              className="order-1 lg:order-2 w-full lg:max-w-[420px]"
            >
              <CheckoutSidebar
            ...
            <div
              className="order-2 lg:order-1 flex flex-col gap-10 mb-20"
            >
              <CheckoutCart
                loading={loading}
                cartItems={cartItems}
